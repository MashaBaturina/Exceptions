...
namespace Exceptions
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //Exceptions
            filteredAutoparkVehicleUnits = autopark.GetAutoByParameter("Transmission Type", "jfsjeojwp");
            autopark.UpdateAuto("jfsjeojwp", autopark.AutoparkVehicleUnits[1]);
            autopark.RemoveAuto("jfsjeojwp");
        }
    }
}
